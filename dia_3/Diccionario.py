...
#Sem esciben como cadenas de texto separando el concepto del valor con dos puntos y una coma por conecpto y valor
...
print(f"EL dato que quisite saber de mi fue {respuesta}")
